...
class SeleniumGridLocal(SeleniumGridService):
    ...
    def setup(self):
        logger.info(f"Selenium Grid docker container started separately.")
    ...
    def shutdown(self):
        logger.info("Selenium Grid docker container at '%s' not stopped. It will be stopped separately..",
                    self.hub_url)
