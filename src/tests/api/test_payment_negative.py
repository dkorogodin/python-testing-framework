...
class TestApiPaymentNegative:
    ...
    def test_get_all_payments_non_existing_token(self, payment_service):
        payment_service.auth.set_token(self.NON_EXISTING_TOKEN)
    ...
    def test_get_payment_non_existing_token(self, payment_service):
